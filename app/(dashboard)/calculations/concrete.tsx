            ...
            <ScrollView contentContainerStyle={styles.content}>
                ...
                {result !== null && (
                    <View style={styles.resultCard}>
                        ...
                        <Text style={styles.resultValue}>{result.toFixed(2)} mآ³</Text>
                        ...
                        <View style={styles.breakdownRow}>
                            <Text style={styles.breakdownLabel}>Sand (mآ³)</Text>
                            <Text style={styles.breakdownValue}>{(result * 0.45).toFixed(2)}</Text>
                        </View>
                        <View style={styles.breakdownRow}>
                            <Text style={styles.breakdownLabel}>Aggregates (mآ³)</Text>
